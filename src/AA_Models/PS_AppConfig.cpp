...
namespace PS{
	...
	//====================================================================================
	vec3f CAppConfig::readVec3f(DAnsiStr section, DAnsiStr variable)
	{
		DAnsiStr strVal;
		vec3f res;
		if(readValue(section, variable, strVal))
	...
	//====================================================================================
	void CAppConfig::writeVec3f(DAnsiStr section, DAnsiStr variable, vec3f val)
	{
		char chrVariable[128];
		snprintf(chrVariable, 128, "(%f, %f, %f)", val.x, val.y, val.z);
		writeValue(section, variable, DAnsiStr(chrVariable));
	}

	//====================================================================================
	vec4f CAppConfig::readVec4f(DAnsiStr section, DAnsiStr variable)
	{
		DAnsiStr strVal;
		vec4f res;
		if(readValue(section, variable, strVal))
	...
	//====================================================================================
	void CAppConfig::writeVec4f(DAnsiStr section, DAnsiStr variable, vec4f val)
	{
		char chrVariable[128];
		snprintf(chrVariable, 128, "(%f, %f, %f, %f)", val.x, val.y, val.z, val.w);
		writeValue(section, variable, DAnsiStr(chrVariable));
	}
	//====================================================================================
